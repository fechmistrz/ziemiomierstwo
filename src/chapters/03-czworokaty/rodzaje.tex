...
Alternatywne definicje głoszą, że ma przeciwległe boki równej długości, albo równe przeciwległe kąty, albo połowiące się wzajemnie przekątne (jak pan Pompe opisał \cite[s. 37]{pompe_2022}).
...
Kwadraty (\emph{squares}) to dokładnie te prostokąty (\emph{rectangles}), które są równocześnie rombami.
Pole kwadratu o boku długości $a$ wynosi $a^2$, jego obwód to $4a$, zaś przekątna ma długość $a \sqrt 2$.
