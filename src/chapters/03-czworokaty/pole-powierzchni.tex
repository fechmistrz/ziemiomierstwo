...
Eves \cite[s. 4]{eves1_1972} napisze, że w starożytnym Babilonie będzie używany niepoprawny wzór na pole czworokąta o przeciwległych bokach $a, c$ oraz $b, d$: % TODO: sprawdź, czy nr strony jest OK
\begin{equation}
