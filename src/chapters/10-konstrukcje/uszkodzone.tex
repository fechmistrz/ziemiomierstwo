...
\begin{geoconstruction}[riga spezzata] % lang-it
\label{broken_ruler_compass_hartshorne_start}% % lang-it
\index{linijka!połamana}% % lang-it
...
\end{geoconstruction} % lang-it
% Hartshorne s. 25 % lang-it
Del problema scrive Eves \cite[p. 181]{eves1_1972}. % lang-it
\begin{geoconstruction}[compasso arrugginito] % lang-it
    \index{cyrkiel!zardzewiały} % lang-it
...
\begin{geoconstruction}[połamana linijka] % lang-pl
\label{broken_ruler_compass_hartshorne_start}% % lang-pl
\index{linijka!połamana}% % lang-pl
...
\end{geoconstruction} % lang-pl
% Hartshorne s. 25 % lang-pl
...
\index[persons]{Buzjani, Abu al-Wafa}% % lang-it

\begin{geoconstruction}[zardzewiały cyrkiel] % lang-pl
    \index{cyrkiel!zardzewiały} % lang-pl
...
\index[persons]{Buzjani, Abu al-Wafa}% % lang-pl
