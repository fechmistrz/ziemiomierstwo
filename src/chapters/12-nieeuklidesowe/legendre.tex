% Źródła: Hartshorne s. 305--306, 319--324; Eves s. 286, 290--291; Greenberg 2010, s. 206, 209; Wikipedia: Adrien-Marie Legendre.
...
Risultati sostanzialmente equivalenti a quelli di Saccheri li scoprirà mezzo secolo dopo, indipendentemente da lui; i suoi \emph{Éléments de géométrie} (1794) avranno molte edizioni, ristampe e traduzioni, che ravviveranno l'interesse per il problema delle parallele \cite[p. 306]{hartshorne_2000}. % lang-it
...
Dimostrazione (assumendo l'infinità della retta e l'assioma di Archimede): Eves \cite[p. 290, es. 11]{eves1_1972}; Hartshorne \cite[p. 320--321]{hartshorne_2000} (teor. 35.2, teorema di Saccheri--Legendre, in un piano di Hilbert con l'assioma di Archimede). % lang-it
Hartshorne sceglie il metodo di Legendre perché la dimostrazione di Saccheri usa un argomento di continuità; in entrambi i casi la dimostrazione usa in modo essenziale l'assioma di Archimede per gli angoli (lemma 35.1) \cite[p. 319]{hartshorne_2000}. % lang-it
...
Hartshorne \cite[p. 322--323]{hartshorne_2000} mostra come Legendre «dimostrerà» il postulato: assumerà che per un punto interno a un angolo passi sempre una retta che interseca entrambi i suoi lati (si veda l'assioma di Legendre nella sezione \ref{sekcja_dobre_stare}). % lang-it
Se così non fosse, per un angolo piccolo a piacere esisterebbe una retta contenuta interamente nell'angolo (es. 35.4), e questo -- scriverà Legendre -- «ripugna alla natura della linea retta» (fr.~\emph{il répugne à la nature de la ligne droite}); stamperà questo ragionamento, tra l'altro, nel manuale del 1823 \cite[p. 322--323]{hartshorne_2000}. % lang-it
