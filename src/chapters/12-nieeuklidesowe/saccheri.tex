% Źródła: Hartshorne s. 304--306; Eves s. 284--285, 298; Greenberg 2010, s. 208--210; Wikipedia: Giovanni Girolamo Saccheri, Tommaso Ceva, Saccheri quadrilateral.
...
Książka nosi tytuł \emph{Euclides ab omni naevo vindicatus} (Euklides oczyszczony ze wszelkiej skazy) i ukaże się tuż przed śmiercią autora; tytuł przypomina słowa Savile'a o dwóch skazach (zobacz sekcję \ref{sekcja_piaty_postulat}) \cite[s. 305]{hartshorne_2000}. % lang-pl
...
Il libro s'intitolerà \emph{Euclides ab omni naevo vindicatus} (Euclide liberato da ogni macchia) e uscirà poco prima della morte dell'autore; il titolo richiama le parole di Savile sui due nei (si veda la sezione \ref{sekcja_piaty_postulat}) \cite[p. 305]{hartshorne_2000}. % lang-it
...
Eves \cite[s. 298]{eves1_1972}; Hartshorne \cite[s. 306]{hartshorne_2000} (tw. 34.1: kąty przy górnej podstawie są równe, a odcinek łączący środki podstaw jest prostopadły do obu). % lang-pl
Eves \cite[p. 298]{eves1_1972}; Hartshorne \cite[p. 306]{hartshorne_2000} (prop. 34.1: gli angoli alla base superiore sono uguali e il segmento che congiunge i punti medi delle basi è perpendicolare a entrambe). % lang-it
...
Questa figura risale a Clavio, che nel commento alla proposizione I.29 proporrà l'assioma dell'equidistanza; l'edizione di Euclide di Clavio sarà raccomandata a Saccheri dal suo maestro Tommaso Ceva, e si può dunque supporre che sia stato Clavio a ispirarlo a studiare ulteriormente questa figura \cite[p. 306]{hartshorne_2000}. % lang-it
...
Saccheri wyprowadzi z niej długi szereg twierdzeń, które dziś czytamy jako twierdzenia geometrii hiperbolicznej, po czym na siłę wmówi sobie sprzeczność, odwołując się do mglistych pojęć o elementach nieskończonych; uzna, że gdyby postulat był fałszywy, istniałyby dwie proste o wspólnej prostopadłej w nieskończoności, co jest „sprzeczne z naturą prostej'' \cite[s. 305--306]{hartshorne_2000}. % lang-pl
...
Da quest'ipotesi dedurrà una lunga serie di teoremi che oggi leggiamo come teoremi della geometria iperbolica, per poi convincersi a forza di aver trovato una contraddizione, appellandosi a nozioni vaghe su elementi infiniti; riterrà che, se il postulato fosse falso, esisterebbero due rette con una perpendicolare comune all'infinito, il che è «contrario alla natura della retta» \cite[p. 305--306]{hartshorne_2000}. % lang-it
...
Oggi si sa che l'esclusione dell'ipotesi dell'angolo ottuso era fragile: Saccheri (e dopo di lui Legendre) la escluderà grazie alla continuità, cioè all'assioma di Archimede, e Max Dehn darà un esempio di piano di Hilbert non archimedeo in cui quell'ipotesi vale \cite[p. 208--209]{greenberg_2010}. % lang-it
Il teorema secondo cui ogni piano di Hilbert è di uno dei tre tipi (somma degli angoli minore, uguale o maggiore di $\pi$ in tutti i triangoli insieme) Saccheri lo aveva già nel 1733, anche se con l'uso della continuità \cite[p. 208]{greenberg_2010}. % lang-it
...
Sembra che il libro sia stato ritirato dal commercio poco dopo la pubblicazione, così che il suo influsso sui contemporanei sarà minimo \cite[p. 285]{eves1_1972}; Hartshorne aggiunge che il lavoro di Saccheri, forse troppo in anticipo sui tempi, non riceverà il riconoscimento dovuto e resterà nell'oblio fino alla fine dell'Ottocento \cite[p. 306]{hartshorne_2000}. % lang-it
