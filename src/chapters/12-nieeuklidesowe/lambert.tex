...
Greenberg \cite[s. 208]{greenberg_2010} przypomina, że Lambert nie był pierwszy: takie czworokąty badali wcześniej Saccheri i Omar Chajjam; dziś nazywa się tak każdy czworokąt o co najmniej trzech kątach prostych. % lang-pl
Greenberg \cite[p. 208]{greenberg_2010} ricorda che Lambert non fu il primo: tali quadrilateri erano stati studiati prima da Saccheri e da Omar Khayyam; oggi si chiama così ogni quadrilatero con almeno tre angoli retti. % lang-it
...
Według Hartshorne'a, którego cytuje Greenberg, Lambert udowodni -- w odróżnieniu od Saccheriego, bez użycia ciągłości -- że wszystkie trójkąty w danej płaszczyźnie mają sumę kątów tego samego typu; ani on, ani Saccheri nie będą wiedzieli, że istnieją płaszczyzny typu rozwartego \cite[s. 208--209]{greenberg_2010}. % lang-pl
Secondo Hartshorne, citato da Greenberg, Lambert dimostrerà -- a differenza di Saccheri, senza usare la continuità -- che tutti i triangoli di un dato piano hanno somma degli angoli dello stesso tipo; né lui né Saccheri sapranno che esistono piani di tipo ottuso \cite[p. 208--209]{greenberg_2010}. % lang-it
