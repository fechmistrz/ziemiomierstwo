% Źródła: Eves s. 284, 288--291; Greenberg 2010, s. 201, 204--207, 210, 214; Wikipedia: Playfair's axiom, John Wallis, Clavius, Clairaut, Proclus.
...
\end{proposition}
\todofoot{Nie znam pewnego sformułowania aksjomatu Simsona (Robert Simson); nie ma go w artykule Greenberga \cite{greenberg_2010} -- potrzebne inne źródło.} % lang-pl
\todofoot{Non conosco con certezza l'enunciato dell'assioma di Simson (Robert Simson); non compare nell'articolo di Greenberg \cite{greenberg_2010} -- serve un'altra fonte.} % lang-it
...
\end{proposition}
\todofoot{Przypisanie tego zdania Bolyaiom (Farkasowi?) do sprawdzenia; Eves \cite[s. 284]{eves1_1972} podaje je bez nazwiska, a Greenberg \cite{greenberg_2010} nie używa tej nazwy.} % lang-pl
\todofoot{Attribuzione di questo enunciato ai Bolyai (a Farkas?) da verificare; Eves \cite[p. 284]{eves1_1972} lo riporta senza nome e Greenberg \cite{greenberg_2010} non usa questo nome.} % lang-it
