...
[assioma di Legendre] % lang-it
	Przez każdy punkt wewnątrz kąta można poprowadzić prostą przecinającą oba ramiona kąta. % lang-pl
	Per ogni punto interno a un angolo si può tracciare una retta che interseca entrambi i lati dell'angolo. % lang-it
\index{aksjomat!Legendre'a}%
\end{proposition}

Ta wersja pochodzi z rozumowania Legendre'a, o którym opowiemy w jego własnej sekcji (Hartshorne \cite[s. 322]{hartshorne_2000}); już dla jednego kąta zakładający ją aksjomat pociąga piąty postulat w płaszczyźnie z aksjomatem Archimedesa \cite[s. 324]{hartshorne_2000} (prop. 35.5). % lang-pl
Eves \cite[s. 284, 290 (zad. 12)]{eves1_1972} podaje wersję dla kątów mniejszych niż $60^\circ$. % lang-pl
Questa versione nasce da un ragionamento di Legendre, di cui parleremo nella sua sezione (Hartshorne \cite[p. 322]{hartshorne_2000}); già per un solo angolo l'assioma che la postula implica il quinto postulato in un piano con l'assioma di Archimede \cite[p. 324]{hartshorne_2000} (prop. 35.5). % lang-it
Eves \cite[p. 284, 290 (es. 12)]{eves1_1972} riporta la versione per angoli minori di $60^\circ$. % lang-it
