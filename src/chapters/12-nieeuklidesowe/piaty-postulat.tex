% Źródła: Hartshorne s. 296--298; Eves s. 283--284; Greenberg 2010, s. 205, 207, 210; Wikipedia: Parallel postulate, Proclus, Clavius, Wallis.
...
W komentarzu do twierdzenia I.29 Proklos przytoczy dowód Ptolemeusza, wskaże jego błędy i poda własny dowód, w którym użyje lematu: jeśli prosta przecina jedną z dwóch prostych równoległych, to przecina też drugą \cite[s. 297]{hartshorne_2000}. % lang-pl
Poważniejszym błędem będzie mówienie o „odległości między prostymi równoległymi'', jakby wszystkie punkty jednej prostej były jednakowo od drugiej oddalone -- a przecież definicja równoległych (proste w jednej płaszczyźnie, które się nie przecinają) tego nie gwarantuje \cite[s. 298]{hartshorne_2000}. % lang-pl
...
Nel commento alla proposizione I.29 Proclo riporterà la dimostrazione di Tolomeo, ne indicherà i difetti e darà la propria, in cui userà un lemma: se una retta interseca una di due rette parallele, interseca anche l'altra \cite[p. 297]{hartshorne_2000}. % lang-it
L'errore più grave sarà parlare di «distanza tra le rette parallele», come se tutti i punti di una retta fossero equidistanti dall'altra -- mentre la definizione di parallele (rette di uno stesso piano che non si incontrano) non lo garantisce \cite[p. 298]{hartshorne_2000}. % lang-it
...
Henry Savile powie w publicznych wykładach o \emph{Elementach} w Oksfordzie w 1621 roku, że w tym pięknym ciele geometrii są dwa pieprzyki, dwie skazy: teoria równoległych i teoria proporcji \cite[s. 304]{hartshorne_2000}. % lang-pl
Teorię proporcji Euklidesa obroni później nowoczesna arytmetyka odcinków (opisana u Hartshorne'a w rozdziale 4), a teoria równoległych zaprowadzi poza geometrię Euklidesa. % lang-pl
Henry Savile dirà nelle lezioni pubbliche sugli \emph{Elementi} a Oxford nel 1621 che in questo bellissimo corpo della geometria ci sono due nei, due imperfezioni: la teoria delle parallele e la teoria delle proporzioni \cite[p. 304]{hartshorne_2000}. % lang-it
La teoria delle proporzioni di Euclide sarà difesa in seguito dall'aritmetica dei segmenti moderna (descritta da Hartshorne nel capitolo 4), mentre la teoria delle parallele porterà oltre la geometria di Euclide. % lang-it
\index[persons]{Savile, Henry}%
