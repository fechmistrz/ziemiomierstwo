...
\begin{axiom}[przystawania, C1] % lang-pl
...
\begin{axiom}[congruenza, C1] % lang-it
...
\begin{axiom}[przystawania, C2] % lang-pl
    Jeśli $AB \cong CD$ oraz $AB \cong EF$, to $CD \cong EF$. % lang-pl
\begin{axiom}[congruenza, C2] % lang-it
...
\begin{axiom}[congruenza, C3] % lang-it
...
\begin{axiom}[przystawania, C3] % lang-pl
...
\begin{proposition}[sottrazione di segmenti] % lang-it
...
\begin{proposition}[odejmowanie odcinków] % lang-pl
...
\end{definition} % Hartshorne 85 % lang-it
...
\begin{definition}[cerchio] % lang-it
...
\begin{definition}[tangente] % lang-it
...
\end{definition} % Hartshorne 85 % lang-pl
...
\begin{definition}[okrąg] % lang-pl
...
\begin{definition}[styczna] % lang-pl
