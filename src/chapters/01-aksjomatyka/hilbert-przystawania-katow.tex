...
\begin{axiom}[przystawania, C4] % lang-pl
...
\begin{axiom}[di congruenza, C4] % lang-it
...
\begin{axiom}[przystawania, C5] % lang-pl
    Niech $\alpha, \beta, \gamma$ będą kątami. % lang-pl
\begin{axiom}[di congruenza, C5] % lang-it
...
\begin{axiom}[di congruenza, C6] % lang-it
...
\begin{axiom}[przystawania, C6] % lang-pl
...
\begin{definition}[angolo adiacente] % lang-it
...
\begin{definition}[kąt przyległy] % lang-pl
