...
Podejście Euklidesa (i tych, którzy pójdą jego śladami) różni się od naszego: na żadnej stronie Elementów nie korzysta się z pojęcia długości odcinka, a jedynie niezdefiniowanego przystawania odcinków.
Podobnie postępuje z kątami (nie istnieje miara kątów, ale jest przystawanie kątów) oraz polami (nie istnieje nic na kształt miary Jordana lub Lebesgue'a, ale pola przystających figur można dodawać i odejmować).
My nie będziemy tak rygorystyczni jak Euklides (ale Hartshorne \cite[s. 165-168]{hartshorne2000} i inni...).
Zdarzy się nam wspomnieć o mierze, na przykład na stronie \pageref{miara_kata_crellea_brocarda}.
