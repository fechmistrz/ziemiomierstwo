...
Greenberg \cite{greenberg_2010} opisze ich historię.
...
Do dwóch wyjątków potrzebujemy dodatkowego aksjomatu \ref{axiom_e}, by okręgi, od których oczekujemy, że się przetną, naprawdę się przecięły.
...
Płaszczyznę Pitagorasa, która spełnia aksjomat (E), nazywamy płaszczyzną Euklidesa.
...
\begin{proposition}
    Dla każdej płaszczyzny Hilberta spełniającej (P) z odcinkiem jednostkowym istnieje jedyne z dokładnością do izomorfizmu ciało uporządkowane, którego dodatnie elementy odpowiadają długościom odcinków.    
\end{proposition}
...
\index{płaszczyzna!Pitagorasa}%
\index{płaszczyzna!Hilberta}%
Na takiej płaszczyźnie (LCI) oraz (E) są sobie równoważne, patrz \cite[s. 191]{hartshorne2000}.
...
Jest to jedno z niewielu miejsc w książce, gdzie z niechęcią wspominamy o wprowadzaniu układu współrzędnych na płaszczyźnie.
Bardziej wylewny będzie Hartshorne \cite[s. 186--194]{hartshorne2000}.
...
Twierdzenie (I.32) głosi, że suma kątów wewnętrznych trójkąta wynosi $\pi$ (patrz Pompe \cite[s. 5]{pompe_2022}, Bogdańska, Neugebauer \cite[s. 7]{neugebauer_2018}).
\index{suma kątów}%
...
Tu czyha pułapka: dla płaszczyzn Hilberta sprowadza się to do postulatu równoległości.
