...
O relacji między aksjomatami B1-B4 i uporządkowaniem ciała, nad którym pracujemy, rozwodzi się Hartshorne \cite[s. 135-140]{hartshorne2000} % lang-pl
Hartshorne \cite[pp.~135--140]{hartshorne2000} discute dettagliatamente la relazione tra gli assiomi B1--B4 e l'ordinamento del campo su cui si lavora. % lang-it
\begin{axiom}[di ordinamento, B1] % lang-it
...
\begin{axiom}[leżenia pomiędzy, B1] % lang-pl
...
\begin{definition}[odcinek] % lang-pl
    Niech $A$, $B$ będą punktami. % lang-pl
\begin{definition}[segmento] % lang-it
...
\begin{definition}[triangolo] % lang-it
...
\begin{definition}[trójkąt] % lang-pl
...
\begin{definition}[semiretta] % lang-it
    Siano $A$ e $B$ due punti. % lang-it
...
\begin{definition}[półprosta] % lang-pl
    Niech $A$, $B$ będą punktami. % lang-pl
