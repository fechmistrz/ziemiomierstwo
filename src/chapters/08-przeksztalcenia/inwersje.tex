...
łańcuchy Steinera % https://en.wikipedia.org/wiki/Steiner_chain The method of circle inversion is helpful in treating Steiner chains. => Audin Audin \cite[s. 109]{audin_2003} używa porism % Coxeter-pl s. 104 Eves 135
...
Nazywali je poryzmatami (wnioskami, rezultatami ubocznymi pojawiającymi się przez przypadek i bez zasługi), stanowiącymi (...) rodzaj spadłego owocu lub daru losu''}. % któraś Delta z 1984
