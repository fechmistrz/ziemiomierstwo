...
% NouvdUs Annales de Malhematiquet, 3rd series, II. 451 (1883). % lang-it

% NouvdUs Annales de Malhematiquet, 3rd series, II. 451 (1883). % lang-pl
...
% https://www.persee.fr/doc/marb_0770-8459_1886_num_37_1_2317 % lang-it

% https://www.persee.fr/doc/marb_0770-8459_1886_num_37_1_2317 % lang-pl
...
\begin{definition}[symediana] % lang-pl
...
\begin{definition}[symmediana] % lang-it
...
\begin{proposition}[punkt Lemoine'a] % lang-pl
\begin{proposition}[punto di Lemoine] % lang-it
    \label{punkt_lemoine}%
...
\begin{proposition}[twierdzenie Schlömilcha] % lang-pl
...
\begin{proposition}[teorema di Schlömilch] % lang-it
...
\index{twierdzenie!Schloemilcha} % lang-pl
...
% https://ems.press/content/serial-article-files/51635 VVV % lang-it

% https://ems.press/content/serial-article-files/51635 VVV % lang-pl
...
\begin{definition}[antyrównoległa] % lang-pl
...
\begin{definition}[antiparallela] % lang-it
