...
\begin{proposition}
[twierdzenie Pascala] % lang-pl
[teorema di Pascal] % lang-it
	Jeżeli punkty $p_1$, $p_2$, $p_3$, $p_4$, $p_5$, $p_6$ leżą na pewnej stożkowej, to punkty $p_1p_2 \cdot p_4p_5$, $p_2p_3 \cdot p_5p_6$ oraz $p_3p_4 \cdot p_6p_1$ są współliniowe (Neugebauer, strona 113). % lang-pl
	Se i punti $p_1$, $p_2$, $p_3$, $p_4$, $p_5$, $p_6$ giacciono su una stessa conica, allora i punti $p_1p_2 \cdot p_4p_5$, $p_2p_3 \cdot p_5p_6$ e $p_3p_4 \cdot p_6p_1$ sono allineati (Neugebauer, pagina 113). % lang-it
...
Audin \cite[pp. 103, 107, 209]{audin_2003} presenta varie versioni di questo teorema. % lang-it
