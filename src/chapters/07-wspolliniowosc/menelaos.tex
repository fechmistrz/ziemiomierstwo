...
[teorema di Menelao] % lang-it
	Dany jest trójkąt $ABC$ oraz punkty $K$, $L$, $M$ leżące odpowiednio na prostych $BC$, $CA$, $AB$ (być może na ich przedłużeniach). % lang-pl
	Sia dato un triangolo $ABC$ e siano $K$, $L$, $M$ punti che giacciono rispettivamente sulle rette $BC$, $CA$, $AB$ (eventualmente sui loro prolungamenti). % lang-it
...
Piszą o nim Guzicki \cite[s. 84]{guzicki_2021}; Hartshorne \cite[s. 180, 181]{hartshorne2000}; Audin \cite[s. 38]{audin_2003}; Zetel \cite[s. 43]{zetel_2020}. % lang-pl
...
Ne scrivono Guzicki \cite[p. 84]{guzicki_2021}; Hartshorne \cite[pp. 180, 181]{hartshorne2000}; Audin \cite[p. 38]{audin_2003} e Zetel \cite[p. 43]{zetel_2020}. % lang-it
