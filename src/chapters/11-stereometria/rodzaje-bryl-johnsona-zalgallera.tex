...
Ludzie będą przypuszczać jednoczęsnie, że każdy wielościan wypukły ma własność Ruperta i że jeden z wielościanów archimedesowych (dwudziesto-dwunastościan rombowy mały) nie ma tej własności.
...
Dopiero w 2025 roku Steininger i Jurkiewicz znajdą kontrprzykład zwany nopertościanem: ma 90 wierzchołków, 240 krawędzi i 152 ściany.
%  Steininger, Jakob; Yurkevich, Sergey (2025), A convex polyhedron without Rupert's property, arXiv:2508.18475
Bardziej przyziemny wynik, że sześcian ma własność Ruperta, opisze Joanna Jaszuńska w $\Delta_{17}^4$. % https://www.deltami.edu.pl/2017/04/niemozliwe-wycinanki/
