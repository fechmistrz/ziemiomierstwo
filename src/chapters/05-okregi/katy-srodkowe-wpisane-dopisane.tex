...
Neugebauer (a poza nim żaden autor podręcznika do geometrii) nazwie nie wiedzieć czemu powyższy wniosek twierdzeniem Apoloniusza. % lang-pl
Neugebauer (e, oltre a lui, nessun autore di manuali di geometria) chiamerà, chissà perché, il corollario precedente teorema di Apollonio. % lang-it
...
\index[persons]{Laertios, Diogenes}% % lang-pl
\index[persons]{Talete di Mileto}% % lang-it
\index[persons]{Laerzio, Diogene}% % lang-it
