...
\begin{definition}[potęga punktu względem okręgu] % lang-pl
\begin{definition}[potenza di un punto rispetto a una circonferenza] % lang-it
...
\begin{proposition}[oś potęgowa istnieje] % lang-pl
\begin{proposition}[esistenza dell'asse radicale] % lang-it
\label{guzicki_6_11}%
...
Oś potęgowa okręgów stycznych to prosta styczna do obydwu okręgów; oś potęgowa okręgów, które się przecinają w dwóch punktach, to prosta przez punkty przecięcia (to ćwiczenie u Hartshorne'a \cite[s. 182]{hartshorne2000}). % lang-pl
...
L'asse radicale di due circonferenze tangenti è la loro tangente comune; l'asse radicale di due circonferenze che si intersecano in due punti è la retta passante per tali punti di intersezione (si tratta di un esercizio in Hartshorne \cite[p. 182]{hartshorne2000}). % lang-it
\begin{proposition}[centro radicale] % lang-it
...
\begin{proposition}[środek potęgowy] % lang-pl
...
Inną konstrukcję opisuje Hartshorne \cite[s. 182]{hartshorne2000}: dane są dwa okręgi o środkach w punktach $O_1, O_2$ oraz promieniach odpowiednio $O_1A_1$, $O_2A_2$. % lang-pl
...
Hartshorne \cite[p. 182]{hartshorne2000} descrive un'altra costruzione: siano date due circonferenze con centri nei punti $O_1$, $O_2$ e raggi rispettivamente $O_1A_1$, $O_2A_2$. % lang-it
...
\begin{theorem}[di Aubert] % lang-it
...
\index[persons]{Aubert, urodzony przed 1899 rokiem}% % lang-it

Nie udało nam się ustalić, kim będzie Aubert, ale najprawdopodobniej udowodni to twierdzenie w 1899 roku. % lang-pl
\index[persons]{Aubert, urodzony przed 1899 rokiem}% % lang-pl
