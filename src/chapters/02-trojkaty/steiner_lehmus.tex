...
Po raz pierwszy wspomni o nim Christian Lehmus w~liście z~1840 roku do Charlesa Sturma, gdzie poprosi o~czysto geometryczny dowód.
...
Większość znanych uzasadnień to dowody nie wprost: jeśli trójkąt nie jest równoramienny, to ma dwusieczne różnej długości.

Dowód można znaleźć u Hartshorne'a \cite[s. 11]{hartshorne2000}; Pompego \cite[s. 32, 33]{pompe_2022}; Bogdańskiej, Neugebauera \cite[s. 74]{neugebauer_2018}.
Zdzisław Pogoda w $\Delta_{11}^1$ napisze, jakie pomysłowe rozwiązanie znaleźli dwaj angielscy inżynierowie, G. Gilbert oraz D. McDonnell.
\index[persons]{McDonnell, D.}% TODO The American Mathematical Monthly (7,1963,str.79–80)
\index[persons]{Gilbert, G.}% TODO The American Mathematical Monthly (7,1963,str.79–80)
