...
Dowód można znaleźć u Hartshorne'a \cite[s. 11]{hartshorne_2000}; Pompego \cite[s. 32, 33]{pompe_2022}; Bogdańskiej, Neugebauera \cite[s. 74]{neugebauer_2018}. % lang-pl
Zdzisław Pogoda w $\Delta_{11}^1$ napisze, jakie pomysłowe rozwiązanie znaleźli dwaj angielscy inżynierowie, G. Gilbert oraz D. McDonnell \cite{gilbert_mcdonnell_1963}. % lang-pl
Una dimostrazione si trova in Hartshorne \cite[p. 11]{hartshorne_2000}, Pompe \cite[pp. 32, 33]{pompe_2022} e Bogdańska, Neugebauer \cite[p. 74]{neugebauer_2018}. % lang-it
Zdzisław Pogoda, in $\Delta_{11}^1$, descrive l'ingegnosa soluzione trovata da due ingegneri inglesi, G. Gilbert e D. McDonnell \cite{gilbert_mcdonnell_1963}. % lang-it
