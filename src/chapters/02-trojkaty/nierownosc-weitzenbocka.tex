...
\end{equation}
patrz na przykład do Guzickiego \cite[s. 363, 365-367]{guzicki_2021}.
\index{punkt Fermata}%
\index{wzór Herona}%
% https://www.ime.usp.br/~toscano/disc/2022/GreenbergGeometry.pdf ps. 34
Nierówność pojawi się też w niezmienionej postaci na III Międzynarodowej Olimpiadzie Matematycznej.
...
\begin{proof}
    Z twierdzenia kosinusów mamy $a^2 = b^2 + c^2 - 2bc \cos \alpha$.
