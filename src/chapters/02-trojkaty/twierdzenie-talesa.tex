...
Napiszą o nim Neugebauer, Bogdańska \cite[s. 48-56]{neugebauer_2018}; Audin \cite[s. 24, 173]{audin_2003}, Hartshorne \cite[s. 177]{hartshorne2000}.
Tradycja przypisuje je Talesowi z Miletu, chociaż znane będzie starożytnym Babilończykom oraz Egipcjanom.
\index[persons]{Tales z Miletu}%
Najstarszy zachowany do później dowód poda Euklides (VI.2).

Po angielsku znane będzie jako \emph{intercept...}, \emph{side splitter...} albo \emph{basic proportionality theorem}; natomiast nazwy \emph{Thales's theorem} użyje się o~dziwo wobec innego wyniku, że kąt oparty na półokręgu jest prosty (!).
...
Napiszą o nim Pompe \cite[s. 39]{pompe_2022} (bezp przytaczania nazwiska Varignona); Bogdańska, Neugebauer \cite[s. 52]{neugebauer_2018}.
Co więcej,
