...
Powyższe zadanie rozwiąże Evangelista Torricelli, który dostanie je w formie wyzwania od Fermata (dlatego też punkt $P$ nazywa się czasem punktem Torricellego; robi tak Guzicki \cite[s. 224-228]{guzicki_2021} albo Zetel \cite[s. 157-164]{zetel_2020}).
...
Patrz też:
Pompe \cite[s. 19-22]{pompe_2022} + $\Delta_{18}^1$,
Neugebauer \cite[s. 117]{neugebauer_2018},
Audin \cite[s. 105]{audin_2003}.
