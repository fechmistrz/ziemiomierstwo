...
Guzicki \cite[s. 357]{guzicki_2021} wytłumaczy dodatkowo, czemu żadnej ze stałych: $\frac 34$, $1$ nie można poprawić.

Mamy też podobną nierówność:

\begin{proposition}
    Niech $a, b, c$ oznacza długości boków trójkąta.
    Wtedy 
    \begin{equation}
...
Lewa połowa jest prawdziwa dla wszystkich dodatnich liczb $a, b, c$ i nosi nazwę nierówności (Alfreda Mortimera) Nesbitta, który znajdzie ją około 1902 roku.
...
Podobnie zrobią Pompe \cite[s. 41]{pompe_2022}, Guzicki \cite[s. 220]{guzicki_2021} albo Bogdańska, Neugebauer \cite[s. 53]{guzicki_2021}.
Zetel \cite[s. 14, 25]{zetel_2020} pokaże, że twierdzenie Cevy daje natychmiast dowód istnienia środka ciężkości.
