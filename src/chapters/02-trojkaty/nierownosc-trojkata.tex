...
Odpowiednikiem nierówności trójkąta w trzech wymiarach zdaje się być ćwiczenie od Kiezy \cite[s. 31]{kieza_2017}:

\begin{proposition}
	W każdym czworościanie suma pól trzech dowolnych ścian jest większa od pola czwartej ściany.
\end{proposition}
