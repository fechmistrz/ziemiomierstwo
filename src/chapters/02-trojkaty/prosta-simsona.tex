...
\begin{proposition}[teorema di Wallace] % lang-it
...
\begin{proposition}[twierdzenie Wallace'a] % lang-pl
...
% \todofoot{HARTSHORNE PRZECHODZI DO PUNKTU MIQUELA} % lang-it

% \todofoot{HARTSHORNE PRZECHODZI DO PUNKTU MIQUELA} % lang-pl
...
\begin{proposition}[twierdzenie Steinera] % lang-pl
	Dany jest trójkąt $ABC$ oraz punkt $P$ leżący na okręgu opisanym na trójkącie. % lang-pl
\begin{proposition}[teorema di Steiner] % lang-it
...
\begin{proposition}[twierdzenie Salmona] % lang-pl
...
\begin{proposition}[teorema di Salmon] % lang-it
