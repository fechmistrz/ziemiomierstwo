...
\begin{proposition}[punto e cerchio di Spieker] % lang-it
\label{punkt_spiekera}% % lang-it
...
\begin{proposition}[punkt i okrąg Spiekera] % lang-pl
\label{punkt_spiekera}% % lang-pl
