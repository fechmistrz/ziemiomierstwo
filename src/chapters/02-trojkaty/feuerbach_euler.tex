...
\begin{proposition}[prosta Eulera]
	\label{prosta_eulera}
	Środek okręgu opisanego na nierównobocznym trójkącie $O$, środek ciężkości $G$ oraz ortocentrum $H$ leżą na jednej prostej, zwanej prostą Eulera.
	\index{prosta!Eulera}
	Mamy $|HG| = 2|OG|$.
\end{proposition}
...
\begin{proposition}
	W nierównoramiennym trójkącie, niech $d$ oznacza odległość między środkiem okręgu wpisanego i~prostą Eulera, $v$ najdłuższą środkową, $u$ najdłuższy bok, zaś $p$ połowę obwodu.
	Wtedy
	\begin{equation}
		\frac ds < \frac du < \frac dv < \frac 13.
	\end{equation}
	Ograniczenia górnego nie można poprawić.
\end{proposition}
...
Bogdańska, Neugebauer \cite[s. 86]{neugebauer_2018} dodają założenie, że trójkąt nie jest prostokątny.
Wynika stąd, że cztery proste Eulera czterech trójkątów przechodzą przez jeden punkt.
