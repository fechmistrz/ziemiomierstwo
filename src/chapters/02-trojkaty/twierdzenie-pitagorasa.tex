...
\index[persons]{Pitagoras z Samos}% % lang-pl
\index[persons]{Pitagora di Samo}% % lang-it
...
\index[persons]{Hippazos z Metapontu}% % lang-pl
\index[persons]{Ippaso di Metaponto}% % lang-it
...
\index[persons]{Teodor(os) z Cyreny}% % lang-pl
\index[persons]{Teodoro di Cirene}% % lang-it
